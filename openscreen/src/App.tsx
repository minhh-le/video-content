...
import { initAutomationBus } from "./automation/automationBus";
import { useGlobalAutomationActions } from "./automation/useGlobalAutomationActions";
...
export default function App() {
	...
	// Wire the automation command bus (MCP) and register window-agnostic actions.
	initAutomationBus();
	useGlobalAutomationActions();
